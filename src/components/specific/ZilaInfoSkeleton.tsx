      ...
      <div className="container mx-auto lg:mb-14 mb-10">
        <div className="bg-white rounded-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 lg:px-6 px-4 pb-4 lg:pb-6">
            {/* Left Section - Map Skeleton */}
            <div className="col-span-12 lg:col-span-4 order-2 lg:order-1 rounded-lg py-6 lg:py-0">
              <div className="w-full h-[200px] lg:h-[300px] bg-gray-200 rounded-lg animate-gray-pulse"></div>
            </div>

            {/* Right Section - Division Buttons and Districts Grid */}
            <div className="col-span-12 lg:col-span-8 order-1 lg:order-2 rounded-lg">
              ...
              <div className="pt-14">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 h-[135px] lg:h-auto overflow-y-auto">
                  {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                    <div
                      key={i}
                      className="flex flex-col justify-between text-center items-center rounded-sm bg-gray-100 py-2"
                    >
                      <div className="h-5 w-24 bg-gray-200 rounded animate-gray-pulse mb-2"></div>
...
export default ZilaInfoSkeleton;
